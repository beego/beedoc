...
>>>One thing you need to care about is he Filter using session must use after `BeforeRouter` because session is not initialized before it. Don't forget enable beego session module (see [Session control](../controller/session.md))
